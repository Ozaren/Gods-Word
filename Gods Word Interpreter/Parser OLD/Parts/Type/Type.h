...
namespace GWI {
    ...
    typedef std::vector<Variable> VarCol;
    ...
    public:
        ...
        bool addFunction(Function &function, int mod);
    ...
    private:
        ...
        std::vector<Type> object_properties;
        // std::vector<std::shared_ptr<TypeFunction>> functions;
        std::vector<TypeFunction> functions;

        void call_help(TypeFunction &function, std::vector<Variable> &vars);
